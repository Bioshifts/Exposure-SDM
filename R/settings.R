...
scratch_dir <- if(computer == "muse"){
    ...
    if(computer=="matrics"){
        "/users/boliveira/archivescratch"
    } else {
...
# Range shift dir supplementary analyses
shift_dir_supp <- function(realm){here::here(work_dir,"Data/SHIFT/Supp",realm)}

# Range shift dir supplementary analyses recalculated
shift_dir_supp_recalc <- function(realm){here::here(work_dir,"Data/SHIFT/Recalc",realm)}
...
# SDMs dir supplementary analyses
sdm_dir_supp <- function(realm){here::here(scratch_dir,"SDMs","Supp",realm)}

# SDMs dir supplementary analyses recalculated
sdm_dir_supp_recalc <- function(realm){here::here(scratch_dir,"SDMs","Recalc",realm)}
