...
#SBATCH -J _proj
#SBATCH -e /storage/simple/projects/t_cesab/brunno/Exposure-SDM/R/2_1_bioclimatic_data/CHELSA/slurm-log-proj/%J-%j-err.log
#SBATCH -o /storage/simple/projects/t_cesab/brunno/Exposure-SDM/R/2_1_bioclimatic_data/CHELSA/slurm-log-proj/%J-%j-out.log
