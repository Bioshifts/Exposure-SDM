...
bioveloMar <- list.files(here("Data/SHIFT/Recalc/Mar"), 
                         full.names = TRUE, 
                         recursive = TRUE, 
                         pattern = "_SA.csv")

bioveloTer <- list.files(here("Data/SHIFT/Recalc/Ter"), 
                         full.names = TRUE, 
                         recursive = TRUE, 
                         pattern = "_SA.csv")
...
if(data_amount=="all"){
    ...
    write.csv(bioshifts, 
              here("Data/Output/ExposureData_all_recal.csv"), 
              row.names = FALSE)
    
} else {
    
    write.csv(bioshifts, 
              here("Data/Output/ExposureData_recal.csv"),
              row.names = FALSE)
...
if(data_amount=="all"){
    ...
    sp_bioshifts <- read.csv(here("Data/Output/ExposureData_all_recal.csv"))
    
} else {
    
    sp_bioshifts <- read.csv(here("Data/Output/ExposureData_recal.csv"))
...
if(data_amount=="all"){
    ...
    write.csv(bioshifts,
              here("Data/Output/Bioshifts_merge_Exposure_all_recal.csv"),
              row.names = FALSE)
    
} else {
    
    write.csv(bioshifts,
              here("Data/Output/Bioshifts_merge_Exposure_recal.csv"),
              row.names = FALSE)
